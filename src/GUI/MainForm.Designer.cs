namespace Draw
{
	partial class MainForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.addRandomTaskShapeMenuItem = new System.Windows.Forms.ToolStripMenuItem();
			...
			this.editToolStripMenuItem.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] {
									this.addRandomTaskShapeMenuItem,
			...
			// 
			// addRandomTaskShapeMenuItem
			// 
			this.addRandomTaskShapeMenuItem.Name = "addRandomTaskShapeMenuItem";
			this.addRandomTaskShapeMenuItem.Size = new System.Drawing.Size(92, 22);
			this.addRandomTaskShapeMenuItem.Text = "Add random task shape";
			this.addRandomTaskShapeMenuItem.Click += new System.EventHandler(this.AddRandomTaskShapeMenuItemClick);
			// 
		...
		private System.Windows.Forms.ToolStripMenuItem addRandomTaskShapeMenuItem;
